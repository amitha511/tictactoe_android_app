...
public class Game extends AppCompatActivity {
    ...
    ImageView pas1,button1,button2,button3,button4,button5,button6,button7,button8,button9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pas1 = findViewById(R.id.mark_pas);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Game.this,"Button Already Pressed",Toast.LENGTH_SHORT).show();
                }
    ...
    private void winningGame(){
        ...
        {
            pas1 = findViewById(R.id.mark_pas);
            pas1.setImageResource(R.drawable.mark6);
            messageWinX();
            xCount++;
            scorex.setText("Score X :- "+String.valueOf(xCount));
        ...
        {
            pas1 = findViewById(R.id.mark_pas);
            pas1.setImageResource(R.drawable.mark7);
            messageWinX();
            xCount++;
            scorex.setText("Score X :- "+String.valueOf(xCount));
        ...
        {
            pas1 = findViewById(R.id.mark_pas);
            pas1.setImageResource(R.drawable.mark8);
            messageWinX();
            xCount++;
            scorex.setText("Score X :- "+String.valueOf(xCount));
        }
        ...
        {
            pas1 = findViewById(R.id.mark_pas);
            pas1.setImageResource(R.drawable.mark3);
            messageWinX();
            xCount++;
            scorex.setText("Score X :- "+String.valueOf(xCount));
        }
        ...
        {
            pas1 = findViewById(R.id.mark_pas);
            pas1.setImageResource(R.drawable.mark4);
            messageWinX();
            xCount++;
            scorex.setText("Score X :- "+String.valueOf(xCount));
        }
        ...
        {
            pas1 = findViewById(R.id.mark_pas);
            pas1.setImageResource(R.drawable.mark5);
            messageWinX();
            xCount++;
            scorex.setText("Score X :- "+String.valueOf(xCount));
        ...
        {
            pas1 = findViewById(R.id.mark_pas);
            pas1.setImageResource(R.drawable.mark1);
            messageWinX();
            xCount++;
            scorex.setText("Score X :- "+String.valueOf(xCount));
        ...
        {
            pas1 = findViewById(R.id.mark_pas);
            pas1.setImageResource(R.drawable.mark2);
            messageWinX();
            xCount++;
            scorex.setText("Score X :- "+String.valueOf(xCount));
        }
